...
const Contact = () => {
  ...
  <img className="w-screen h-screen object-none object-top brightness-75" src={contactPageBackground_lg} loading="lazy" alt="Contact page background" />
  <img className="absolute top-0 left-1/2 -translate-x-1/2 w-[300px] pt-12" src={logoWhite} alt="Armony Hair Studio logo" />
  ...
  <img className="w-[300px]" src={logoBlack} alt="Armony Hair Studio logo black" />
        ...
        <a href={`${contactInformation.instagramPage}`} target="_blank" rel="noopener noreferrer" className="pt-8">
          <img src={instagramColorIcon} className="w-[30px] h-[30px] min-w-6 min-h-6" alt="Instagram icon" />
        </a>
        <div className="mt-20">
          <FooterNavbar />
        </div>
